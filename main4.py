...
STEPS = 1900  # Número de pasos para cada dirección
...
def capture_image():
    subprocess.run(["libcamera-still", "-t", "2000", "-n", "-o", "test.jpg"])
...
def capture_and_classify():
    ...
    if classId in classDic:
        ...
        # Si el ClassId es 8, ejecuta el control del motor
        if classId == 8 or classId == 5:
            print("Ejecutando el motor para el ID 8 o 5")
            control_motor()
